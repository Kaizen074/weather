...
- You can add  it to your HTML head section, just like this:
  ...
  <head>
    <...> Other stuff </...>
    <script src="steroid-wallpaper.js"></script> <!-- LIKE THIS -->
...
By calling **`steroid.verification()`**, your account details will be verified with your **`wallpaper_token`** and **`user_id`**, to return your user information and details.
```javascript
